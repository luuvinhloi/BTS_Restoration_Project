...
- flood_depth_combined_clean.tif
- flood_area_combined_clean.geojson
"""
...
def clean_outputs(boundary_gdf, transform, ref_ds):
    ...
    # --- Paths ---
    raster_path = OUTPUT_DIR / "flood_depth_combined.tif"
    raster_clean = OUTPUT_DIR / "flood_depth_combined_clean.tif"
...
def main():
    ...
    with rasterio.open(DEM_PATH) as dem_src:
        ...
        poly.to_file(OUTPUT_DIR / "flood_area_combined.geojson", driver="GeoJSON")
