...
Compute population coverage summary_B using GA-PSO assignment outputs.
Inputs (GA-PSO):
 - outputs/results_ga_pso_B/solution_cow_assignments.csv
 - outputs/results_ga_pso_B/solution_power_assignments.csv

Output:
 - outputs/summary_B/ga_pso/*.csv, *.geojson, coverage_report_ga_pso.json
...
ASSIGN_COW_GAPSO = OUT_DIR / "results_ga_pso_B" / "solution_cow_assignments.csv"
ASSIGN_POWER_GAPSO = OUT_DIR / "results_ga_pso_B" / "solution_power_assignments.csv"
...
SUMMARY_DIR = OUT_DIR / "summary_B" / "ga_pso"
