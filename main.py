...
def run_pipeline(config_path):
    ...
    print("2) Generating damage scenario...")
    ...
    print("4) Computing travel time & cost matrix...")
    ...
    if method == "MILP":
        ...
        print("5) Solving with MILP (Phương pháp 1 - PuLP Lexicographic)...")
        out = milp_lexi_solve(
    ...
    print("6) Computing population coverage (outage / COW coverage)...")
    try:
    ...
    #  Visualization
    print("7) Running simulation scenario...")
    if method == "MILP":
